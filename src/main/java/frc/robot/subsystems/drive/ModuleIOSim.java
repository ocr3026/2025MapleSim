...
public class ModuleIOSim implements ModuleIO {
	...
	public void updateInputs(ModuleIOInputs inputs) {
		...
		inputs.drivePosition =
				Meters.of(moduleSimulation.getDriveWheelFinalPosition().in(Radians) * wheelRadius.in(Meters));
		inputs.driveVelocity = MetersPerSecond.of(
				moduleSimulation.getDriveWheelFinalSpeed().in(RadiansPerSecond) * wheelRadius.in(Meters));
