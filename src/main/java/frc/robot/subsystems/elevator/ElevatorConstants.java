...
public final class ElevatorConstants {
	...
	public static final double encoderPositionFactor = Math.PI * spoolDiameter.in(Inches) / elevatorReduction;
	public static final double encoderVelocityFactor = Math.PI * spoolDiameter.in(Inches) / (elevatorReduction * 60);
